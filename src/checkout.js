...
(function ($, document) {
    class giftyGiftCards {
        ...
        bindEvents() {
            ...
            $(document).on('input', '#gifty_cart_code', this.handleGiftCardCodeInput.bind(this));
            $(document).on('keypress', '#gifty_cart_code', this.handleGiftCardCodeInput.bind(this));

            // Bind to #gifty_cart_submit button
            $(document).on('click', '#gifty_cart_submit', this.handleGiftCardSubmit.bind(this));

            // Bind to .gifty-gift-card-remove button
            $(document).on('click', '.gifty-gift-card-remove', this.handleGiftCardRemove.bind(this));
        }
        ...
        displayCartNotice(message, type) {
            ...
            const noticesContainer = document.getElementById('gifty_gift_card_notices_wrapper') || document.querySelector('.woocommerce-notices-wrapper');
        ...
        handleGiftCardCodeInput(event) {
            ...
            const codeInput = document.getElementById('gifty_cart_code').value;
        ...
        handleGiftCardSubmit(event) {
            ...
            request.onload = () => {
                if (
                    ...
                    const errorMessage = request.response?.data || request.response;
